...
final class Version20251202210500 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE `tbl_enigma` (id INT AUTO_INCREMENT NOT NULL, game_id INT NOT NULL, type_id INT NOT NULL, title VARCHAR(255) NOT NULL, `order` INT NOT NULL COMMENT \'Enigma order in sequence\', instruction LONGTEXT DEFAULT NULL, secret_code VARCHAR(255) DEFAULT NULL, INDEX IDX_A30FBED1E48FD905 (game_id), INDEX IDX_A30FBED1C54C8C93 (type_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
